...
//	----------------------------------------------
	...
	public ContainerBlockGUI(InventoryPlayer par1InventoryPlayer, TileEntityBlockGUI par2TileEntity) {
		tile = par2TileEntity;
        this.addSlotToContainer(new Slot(par2TileEntity, 0, 49, 19));
        this.addSlotToContainer(new Slot(par2TileEntity, 1, 112, 19));
        this.addSlotToContainer(new Slot(par2TileEntity, 2, 80, 54));
        int var3;
